                    ...
                    >
                        ...
                        @foreach($agency as $agent)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('viewAgentDetails',$agent->agentId)}}"><input type="button" class="btn btn-success"
                                                                                              name="update"
